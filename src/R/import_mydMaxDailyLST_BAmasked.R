...
src_list <- list.files("../data_general/MYD11A2_C6_LST/","maxMonLST",full.names = T)
...
out %>% 
  write_parquet(., sink = "../data_general/MYD11A2_C6_LST/MYD11A2_C6_maxMonLST_1km_EastOz_NVIStreeClassMask_2003_2019.parquet", 
                compression='gzip', 
                compression_level = 9)
